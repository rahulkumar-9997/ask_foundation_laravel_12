...
<div class="content">
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            @endif
            <form action="{{ route('manage-doctors.update', $doctor->id) }}" method="POST" enctype="multipart/form-data" id="doctorsFormEdit">
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="col-sm-4 col-12">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('doctor_name') is-invalid @enderror"
                                id="doctor_name" name="doctor_name" value="{{ old('doctor_name', $doctor->doctor_name) }}" />
                            @error('doctor_name')
                    ...
                    <div class="col-sm-4 col-12">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('doctor_department') is-invalid @enderror"
                                id="doctor_department" name="doctor_department"
                                value="{{ old('doctor_department', $doctor->department) }}">
                    ...
                    <div class="col-sm-4 col-12">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('doctor_experience') is-invalid @enderror"
                                id="doctor_experience" name="doctor_experience"
                                value="{{ old('doctor_experience', $doctor->experience) }}">
                    ...
                    <div class="col-sm-4 col-12">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('work_location') is-invalid @enderror"
                                ...
                                value="{{ old('work_location', $doctor->work_location) }}">
                            @error('work_location')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-sm-4 col-12">
                        <div class="mb-3">
                            ...
                            @if($doctor->image)
                            <div class="mt-2">
                                <img src="{{ asset('upload/doctors/' . $doctor->image) }}" width="100" class="img-thumbnail">
                    ...
                    <div class="col-sm-4 col-12">
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('short_content') is-invalid @enderror"
                                id="short_content" name="short_content" rows="2">{{ old('short_content', $doctor->short_content) }}</textarea>
                            @error('short_content')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="d-flex align-items-center justify-content-end mb-4">
                            <a href="{{ route('manage-doctors.index') }}" class="btn btn-secondary me-2">Cancel</a>
