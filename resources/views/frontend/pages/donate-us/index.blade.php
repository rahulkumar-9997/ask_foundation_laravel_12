                    ...
                    <div class="row donate-row">
                        ...
                        <div class="col-lg-6">
                            <div class="donate-form campaign-donate-form">
                                ...
                                <form id="donateForm" class="UI-form" method="POST" action="" novalidate>
                                    @csrf
                                    <div class="Field Field--required Field--amount Field--currency-1">
                                        ...
                                        <div class="Field-content">
                                            <div class="Field-wrapper">
                                                ...
                                                <input class="Field-el" type="number" name="amount" placeholder="Enter Amount" required aria-label="Enter your Amount">
                                            </div>
                                        ...
                                        <div class="Field-content">
                                            <div class="selectoption">
                                                <div class="input-with-select">
                                                    <select name="salutation" id="salutation" class="form-group mb-0 valid" aria-invalid="false">
                                                ...
                                                <div class="Field-wrapper">
                                                    <input class="Field-el" type="text" name="name" placeholder="Enter your Name" required aria-label="Enter your Name">
                                                </div>
                                            </div>                                           
                                        </div>
                                    </div>
                                    <div class="Field Field--required">
                                        ...
                                        <div class="Field-content">
                                            <div class="Field-wrapper">
                                                <input class="Field-el" type="text" name="pan_number" placeholder="Enter your PAN Number" required aria-label="Enter your PAN Number">
                                            </div>
                                    ...
                                    <div class="Field Field--required">
                                        ...
                                        <div class="Field-content">
                                            <div class="Field-wrapper">
                                                <input class="Field-el" type="email" name="email" placeholder="Enter your Email" required aria-label="Enter your Email">
                                            </div>                                            
                                        </div>
                                    </div>
                                    <div class="Field Field--required">
                                        ...
                                        <div class="Field-content">
                                            <div class="Field-wrapper">
                                                <input class="Field-el" type="tel" name="mobile" placeholder="Enter your Mobile" minlength="8" required aria-label="Enter your Mobile">
                                            </div>
                                            
                                        </div>
                                    </div>
                                    <div id="form-footer" class="form-footer-payment mt-4">
                                        ...
                                        <button type="submit" class="btn btn--gradient" tabindex="0">
                                            Donate <span style="margin-left: 4px;">₹ 0.00</span>
                                        </button>
                                    </div>
                                </form>
